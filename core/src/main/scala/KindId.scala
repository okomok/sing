...
object KindId {
    import Dense._
     ...
     def fresh[bs <: Dense](bs: bs): fresh[bs] = _0B :: bs.tail
    type fresh[bs <: Dense]                    = _0B :: bs#tail
    ...
    lazy val _ofAny: _ofAny                         = _1B :: DNil
        type _ofAny                                 = _1B :: DNil
...
// Singles
    ...
    lazy val _ofBoxed: _ofBoxed                     = _1B :: _ofAny
        type _ofBoxed                               = _1B :: _ofAny

    lazy val ofBoxed: ofBoxed = rev(_ofBoxed)
        type ofBoxed          = rev[_ofBoxed]

    lazy val _ofEither: _ofEither                   = _1B :: fresh(_ofBoxed)
        type _ofEither                              = _1B :: fresh[_ofBoxed]

    lazy val ofEither: ofEither = rev(_ofEither)
        type ofEither           = rev[_ofEither]

    lazy val _ofFunction0: _ofFunction0             = _1B :: fresh(_ofEither)
        type _ofFunction0                           = _1B :: fresh[_ofEither]

    lazy val ofFunction0: ofFunction0 = rev(_ofFunction0)
        type ofFunction0              = rev[_ofFunction0]

    lazy val _ofFunction2: _ofFunction2             = _1B :: fresh(_ofFunction0)
        type _ofFunction2                           = _1B :: fresh[_ofFunction0]

    lazy val ofFunction2: ofFunction2 = rev(_ofFunction2)
        type ofFunction2              = rev[_ofFunction2]

    lazy val _ofFunction3: _ofFunction3             = _1B :: fresh(_ofFunction2)
        type _ofFunction3                           = _1B :: fresh[_ofFunction2]

    lazy val ofFunction3: ofFunction3 = rev(_ofFunction3)
        type ofFunction3              = rev[_ofFunction3]

    lazy val _ofKind: _ofKind                       = _1B :: fresh(_ofFunction3)
        type _ofKind                                = _1B :: fresh[_ofFunction3]

    lazy val ofKind: ofKind = rev(_ofKind)
        type ofKind         = rev[_ofKind]

    lazy val _ofOption: _ofOption                   = _1B :: fresh(_ofKind)
        type _ofOption                              = _1B :: fresh[_ofKind]

    lazy val ofOption: ofOption = rev(_ofOption)
        type ofOption           = rev[_ofOption]

    lazy val _ofSet: _ofSet                         = _1B :: fresh(_ofOption)
        type _ofSet                                 = _1B :: fresh[_ofOption]

    lazy val ofSet: ofSet = rev(_ofSet)
        type ofSet        = rev[_ofSet]

    lazy val _ofUnit: _ofUnit                       = _1B :: fresh(_ofSet)
        type _ofUnit                                = _1B :: fresh[_ofSet]
...
// Nats
    ...
    lazy val _ofNat: _ofNat                         = _1B :: fresh(_ofUnit)
        type _ofNat                                 = _1B :: fresh[_ofUnit]

    lazy val ofNat: ofNat = rev(_ofNat)
        type ofNat        = rev[_ofNat]

    lazy val _ofBoolean: _ofBoolean                 = _1B :: _ofNat
        type _ofBoolean                             = _1B :: _ofNat
...
// Lists
    ...
    lazy val _ofList: _ofList                       = _1B :: fresh(fresh(_ofBoolean))
        type _ofList                                = _1B :: fresh[fresh[_ofBoolean]]

    lazy val ofList: ofList = rev(_ofList)
        type ofList         = rev[_ofList]

    lazy val _ofProduct: _ofProduct                 = _1B :: fresh(_ofList)
        type _ofProduct                             = _1B :: fresh[_ofList]

    lazy val ofProduct: ofProduct = rev(_ofProduct)
        type ofProduct            = rev[_ofProduct]

    lazy val _ofProduct1: _ofProduct1               = _1B :: _ofProduct
        type _ofProduct1                            = _1B :: _ofProduct

    lazy val ofProduct1: ofProduct1 = rev(_ofProduct1)
        type ofProduct1             = rev[_ofProduct1]

    lazy val _ofProduct2: _ofProduct2               = _1B :: fresh(_ofProduct1)
        type _ofProduct2                            = _1B :: fresh[_ofProduct1]

    lazy val ofProduct2: ofProduct2 = rev(_ofProduct2)
        type ofProduct2             = rev[_ofProduct2]

    lazy val _ofProduct3: _ofProduct3               = _1B :: fresh(_ofProduct2)
        type _ofProduct3                            = _1B :: fresh[_ofProduct2]
...
// Relations
    ...
    lazy val _ofRelation: _ofRelation               = _1B :: fresh(fresh(fresh(fresh(_ofProduct3))))
        type _ofRelation                            = _1B :: fresh[fresh[fresh[fresh[_ofProduct3]]]]

    lazy val ofRelation: ofRelation = rev(_ofRelation)
        type ofRelation             = rev[_ofRelation]

    lazy val _ofEquiv: _ofEquiv                     = _1B :: _ofRelation
        type _ofEquiv                               = _1B :: _ofRelation

    lazy val ofEquiv: ofEquiv = rev(_ofEquiv)
        type ofEquiv          = rev[_ofEquiv]

    lazy val _ofPartialOrdering: _ofPartialOrdering = _1B :: _ofEquiv
        type _ofPartialOrdering                     = _1B :: _ofEquiv

    lazy val ofPartialOrdering: ofPartialOrdering = rev(_ofPartialOrdering)
        type ofPartialOrdering                    = rev[_ofPartialOrdering]

    lazy val _ofOrdering: _ofOrdering               = _1B :: _ofPartialOrdering
        type _ofOrdering                            = _1B :: _ofPartialOrdering
...
// Function1s (extends Relation)
    ...
    lazy val _ofFunction1: _ofFunction1             = _1B :: fresh(fresh(fresh(_ofOrdering)))
        type _ofFunction1                           = _1B :: fresh[fresh[fresh[_ofOrdering]]]

    lazy val ofFunction1: ofFunction1 = rev(_ofFunction1)
        type ofFunction1              = rev[_ofFunction1]

    lazy val _ofPartialFunction: _ofPartialFunction = _1B :: _ofFunction1
        type _ofPartialFunction                     = _1B :: _ofFunction1

    lazy val ofPartialFunction: ofPartialFunction = rev(_ofPartialFunction)
        type ofPartialFunction                    = rev[_ofPartialFunction]

    lazy val _ofMap: _ofMap                         = _1B :: _ofPartialFunction
        type _ofMap                                 = _1B :: _ofPartialFunction
