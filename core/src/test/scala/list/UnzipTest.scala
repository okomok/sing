...
class UnzipTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        type z = l1#zip[l2]
        val z: z = l1.zip(l2)
        Test.cassertSame[Tuple2[_Box[Int], _Box[java.lang.Integer]] :: Tuple2[_Box[String], _Box[Char]] :: Tuple2[_Box[java.lang.Integer], _Box[Int]] :: Nil, z#force]

        type k = z#unzip
        val k: k = z.unzip
        Test.cassertSame[Tuple2[_Box[Int] :: _Box[String] :: _Box[java.lang.Integer] :: Nil, _Box[java.lang.Integer] :: _Box[Char] :: _Box[Int] :: Nil], List.force2[k]]
    ...
    def testNil {
        ...
        type z = l1#zip[l2]
        val z: z = l1.zip(l2)
        Test.cassertSame[Nil, z#force]

        type k = z#unzip
        val k: k = z.unzip
        Test.cassertSame[Tuple2[Nil, Nil], List.force2[k]]
