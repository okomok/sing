...
class OrderingTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        AssertTrue[List.lexicographicalOrdering[Nat.naturalOrdering]#equiv[xs, ys]]
    ...
    def testNilYS {
        ...
        AssertTrue[List.lexicographicalOrdering[Nat.naturalOrdering]#lt[xs, ys]]
    ...
    def testXSNil {
        ...
        AssertTrue[List.lexicographicalOrdering[Nat.naturalOrdering]#gt[xs, ys]]
    ...
    def testComplicated2 {
        ...
        AssertTrue[List.lexicographicalOrdering[Nat.naturalOrdering]#lt[ys, xs]]
