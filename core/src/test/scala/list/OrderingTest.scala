...
class OrderingTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        Test.cassert[List.lexicographicalOrdering[Nat.naturalOrdering]#equiv[xs, ys]]
    ...
    def testNilYS {
        ...
        Test.cassert[List.lexicographicalOrdering[Nat.naturalOrdering]#lt[xs, ys]]
    ...
    def testXSNil {
        ...
        Test.cassert[List.lexicographicalOrdering[Nat.naturalOrdering]#gt[xs, ys]]
    ...
    def testComplicated2 {
        ...
        Test.cassert[List.lexicographicalOrdering[Nat.naturalOrdering]#lt[ys, xs]]
