...
object TakeTezt {
    ...
    trait testTrivial {
        ...
        cassertEq[Nil, lst#take[_0]#force]
        cassertEq[_Box[Int] :: _Box[String] :: Nil, lst#take[_2]#force]
        cassertEq[_Box[Int] :: _Box[String] :: _Box[Double] :: _Box[Char] :: _Box[Float] :: Nil, lst#take[_5]#force]
    }
}
