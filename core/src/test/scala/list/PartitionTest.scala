...
class PartitionTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        weak.assertSame[Tuple2[_2 :: _6 :: _7 :: Nil, _9 :: _10 :: _8 :: _9 :: Nil], list.force2[u]]
    ...
    def testTakeAll {
        ...
        type u = xs#partition[Lt8]
        val u: u = xs.partition(Lt8())
        weak.assertSame[Tuple2[xs, Nil], list.force2[u]]
    ...
    def testTakeNothing {
        ...
        type u = xs#partition[Lt8]
        val u: u = xs.partition(Lt8())
        weak.assertSame[Tuple2[Nil, xs], list.force2[u]]
