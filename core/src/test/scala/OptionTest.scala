    ...
    def testUnsing {
        {
            type s = Some[_Box[Int]]
            val s: s = Some(_Box(3))
            AssertEq[scala.Some[Int], s#unsing]
        ...
        }
        {
            type s = None
            val s: s = None
            AssertEq[scala.None.type, s#unsing]
            val e: s#unsing = s.unsing
...
*/
    def testGetOrElse {
        type s = Some[_3]
        val s: s = Some(_3)
        AssertEq[_3, s#getOrElse[Const[_8]]]
    ...
    def testFlatMapSome {
        type s = Some[_3]
        val s: s = Some(_3)
        AssertEq[Some[_4], s#flatMap[Plus1Get]]
    ...
    def testOrElseSome {
        type s = Some[_3]
        val s: s = Some(_3)
        AssertEq[Some[_3], s#orElse[Some4]]
    ...
    def testOrElseNone {
        type s = None
        val s: s = None
        AssertEq[Some[_4], s#orElse[Some4]]
        val m: s#orElse[Some4] = s.orElse(Some4())
        assertEquals(Some(_4), m)
    }
    ...
    def testNaturalOrdering1 {
        val s = Some(_5)
        val t = Some(_6)
        AssertTrue(s.kind.naturalOrdering.lt(s, t))
    }
    ...
    def testNaturalOrdering3 {
        val s = Some(_6)
        val t = Some(_6)
        AssertTrue(s.kind.naturalOrdering.equiv(s, t))
    }
