...
class ConversionTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testToPeano {
        ...
        Test.cassertEq[Peano._0, Dense._0#asNat#asPeano]
        Test.cassertEq[Peano._6, Dense._6#asNat#asPeano]
        Test.cassertEq[Peano._5, Dense._2#plus[Dense._3]#asNat#asPeano]
