...
class EitherTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivialLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassert[s#isLeft]
        assertEquals(`true`, s.isLeft)
        Test.cassertNot[s#isRight]
    ...
    def testTrivialRight {
        type s = Right[_3]
        val s: s = Right(_3)
        Test.cassert[s#isRight]
        assertEquals(`true`, s.isRight)
        Test.cassertNot[s#isLeft]
    ...
    def testUnsingLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassertSame[scala.Left[Int, _], s#unsing]
    ...
    def testUnsingRight {
        type s = Right[_3]
        val s: s = Right(_3)
        Test.cassertSame[scala.Right[_, Int], s#unsing]
    ...
    def testSwapLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassertSame[Right[_3], s#swap]
        val m: s#swap = s.swap
    ...
    def testSwapRight {
        type s = Right[_3]
        val s: s = Right(_3)
        Test.cassertSame[Left[_3], s#swap]
        val m: s#swap = s.swap
    ...
    def testJoinLeftLeft {
        ...
        Test.cassertSame[Right[_3], s#joinLeft]
    ...
    def testJoinRightRight {
        ...
        Test.cassertSame[Left[_3], s#joinRight]
    ...
    def testFoldLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassertSame[_4, s#fold[Plus1, Plus2]]
    ...
    def testFoldRight {
        type s = Right[_3]
        val s: s = Right(_3)
        Test.cassertSame[_5, s#fold[Plus1, Plus2]]
        val m: s#fold[Plus1, Plus2] = s.fold(Plus1(), Plus2())
        assertEquals(_5, m)
    }
