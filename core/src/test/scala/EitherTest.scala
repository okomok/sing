...
class EitherTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testUnsingLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassertEq[scala.Left[Int, _], s#unsing]
    ...
    def testUnsingRight {
        type s = Right[_3]
        val s: s = Right(_3)
        Test.cassertEq[scala.Right[_, Int], s#unsing]
    ...
    def testSwapLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassertEq[Right[_3], s#swap]
        val m: s#swap = s.swap
    ...
    def testJoinLeftLeft {
        ...
        Test.cassertEq[Right[_3], s#joinLeft]
    ...
    def testJoinRightRight {
        ...
        Test.cassertEq[Left[_3], s#joinRight]
    ...
    def testFoldLeft {
        type s = Left[_3]
        val s: s = Left(_3)
        Test.cassertEq[_4, s#fold[Plus1, Plus2]]
    ...
    def testFoldRight {
        type s = Right[_3]
        val s: s = Right(_3)
        Test.cassertEq[_5, s#fold[Plus1, Plus2]]
        val m: s#fold[Plus1, Plus2] = s.fold(Plus1(), Plus2())
        assertEquals(_5, m)
    }
