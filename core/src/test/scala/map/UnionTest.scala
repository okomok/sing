...
class UnionTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        Test.assertEq[`true`, SortedMap.empty[Nat.naturalOrdering]#put[_4, _5]#put[_3, _4]#put[_5, _6]#put[_0, _1]#put[_1, _2]#put[_2, _3]#equalWith[um, Nat.naturalOrdering]]
    ...
    def testEmpty {
        ...
        Test.assertEq[SortedMap.empty[Nat.naturalOrdering], um]
    ...
    def testEmpty2 {
        ...
        Test.assertEq[`true`,  SortedMap.empty[Nat.naturalOrdering]#put[_3, _4]#put[_1, _2]#put[_2, _3]#equalWith[um, Nat.naturalOrdering]]
   ...
   def testLeftBiased {
        ...
        Test.assertEq[`true`,  SortedMap.empty[Nat.naturalOrdering]#put[_4, _5]#put[_3, _4]#put[_5, _6]#put[_0, _1]#put[_2, _3]#equalWith[um, Nat.naturalOrdering]]
