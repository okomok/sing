...
class RemoveTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial1 {
        ...
        Test.cassertEq[Dense._8, rm#size]
        Test.cassertEq[None, rm#get[_1]]
        AssertInvariant(rm)
        ()
    }
    ...
    def testTrivial14 {
        ...
        Test.cassertEq[Dense._8, rm#size]
        Test.cassertEq[None, rm#get[_14]]
        AssertInvariant(rm)
        ()
    }
