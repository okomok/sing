...
class RemoveTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        Test.cassertSame[Dense._2, rm#size]
        Test.cassertSame[None, rm#get[_5]]
        AssertInvariant(rm)
        ()
    }
    ...
    def testTrivial1 {
        ...
        Test.cassertSame[Dense._8, rm#size]
        Test.cassertSame[None, rm#get[_1]]
        AssertInvariant(rm)
        ()
    }
    ...
    def testTrivial3 {
        ...
        Test.cassertSame[Dense._8, rm#size]
        Test.cassertSame[None, rm#get[_3]]
        AssertInvariant(rm)
        //println(rm)
        ()
    }
    ...
    def testTrivial8 {
        ...
        Test.cassertSame[Dense._8, rm#size]
        Test.cassertSame[None, rm#get[_8]]
        AssertInvariant(rm)
        ()
    }
    ...
    def testTrivial14 {
        ...
        Test.cassertSame[Dense._8, rm#size]
        Test.cassertSame[None, rm#get[_14]]
        AssertInvariant(rm)
        ()
    }
    ...
    def testTrivial6 {
        ...
        Test.cassertSame[Dense._8, rm#size]
        Test.cassertSame[None, rm#get[_6]]
        AssertInvariant(rm)
        ()
    }
